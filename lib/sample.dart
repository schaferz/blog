...
class SetupFlowState extends State<SetupFlow> {
  ...
  Route<Widget> _onGenerateRoute(RouteSettings settings) {
    final page = switch (settings.name) {
      ...
      routeDeviceSetupSelectDevicePage => SelectDevicePage(onDeviceSelected: _onDeviceSelected),
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Select a nearby device:', style: Theme.of(context).textTheme.titleLarge),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Bulb 22n483nk5834', style: TextStyle(fontSize: 24)),
                ),
              ),
            ],
          ),
...
class WaitingPage extends StatefulWidget {
  const WaitingPage({super.key, required this.message, required this.onWaitComplete});
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Center(child: Icon(Icons.lightbulb, size: 140, color: Colors.white)),
                ),
                const SizedBox(height: 32),
                const Text(
                  'Bulb added!',
